    ...
    const onsubmit = (data) => {
        createUser(data.email, data.password)
            .then(newUser => {
                ...
                return updateProfile(newUser.user, {
                            ...
                            <div>
                                ...
                                <label className="input input-bordered flex items-center gap-2 lg:w-4/5">
                                    ...
                                    <input type="text" className="grow" placeholder="Username"
                                        {...register("username", { pattern: { value: /^[a-z0-9_]{6,}$/, message: 'Username should should contain a minimum of 6 letters with no capital case and special charecters!' }, required: '*This field is required' })} />
                                </label>
                                {
                                    errors.username && (
                                        <span className="text-red-500 text-sm font-medium">{errors.username.message}</span>
                                    )
                                }
                            </div>
                            <div>
