            ...
            <div className="flex flex-col lg:flex-row items-center">
                ...
                <div className="w-full lg:w-1/2">
                    ...
                    <div className="flex gap-3 my-5">
                        <button className="font-medium text-base md:text-sm lg:text-base border-2 px-10 md:px-14 py-4 rounded-md border-black bg-white hover:bg-black hover:text-white transition">Add to cart</button>
